...
prompt_template = (
  ...
  "{context_str}"
  "\n---------------------\n"
  "You are a helpful AI assistant who has been listening to everything everyone has been saying. Your username is @{bot_name}. Messages starting with '\l' or '\llama' are directed towards you.\n"
  "Now @{user_asking} is asking a question that you'll answer correctly, using the most recent and relevant information from above. Just write your response to @{user_asking} and nothing else"
