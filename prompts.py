...
prompt_template = (
  ...
  "Following is a series of discord chat messages. Each chat message is in this format: [when the message was posted] - @user_who_posted on #[channel_where_message_was_posted]: `message_content`\n"
  ...
  "\n{replies}"
  "\n-------------------"
  "\nNow @{user_asking} is asking a question that you'll answer correctly, using the most recent and relevant information from the chat messages above. If you can't correctly answer the query from the above chat messages, then briefy say that you didn't find that info from previous conversations."
